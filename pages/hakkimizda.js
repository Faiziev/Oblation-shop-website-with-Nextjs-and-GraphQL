  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="Yıldırım Kurban Satış Evi, alanındaki faaliyetlerini 20 yılı aşkın süredir sürdürmektedir. 2007 yılından itibaren Yıldırım Kurban Satış Evi olarak Esenyurt bölgesinde faaliyet göstermektedir." />
          ...
          <Stack width="100%" spacing={6}>
            <Stack width="100%" spacing={3} justifyContent="center" alignItems="center">
              ...
              <Span kind={tablet ? 'h2' : 'h1'} style={{ textAlign: 'center' }}>
                ...
                <br />
                <br />
                Yildirim Kurban Satış Evi bünyesinde gerçekleştirilen tüm kurban kesimlerinden artakalan hayvan derisi gibi atıklar değerlendir ve ilgili yerlere satışı yapılır. Buradan elde edilen kazanç ise öğrencilere burs olarak gider. Bu sayede bir çok öğrenciye burs imkanı sağlanmıştır.
                <br />
                <br />
                Yildirim; adak kurban satışı, canlı hayvan satışı, akika kurban, nezir kurbanı, şükür kurbanı ve vacip kurban alanlarında hizmet vermektedir.
                <br />
                <br />
