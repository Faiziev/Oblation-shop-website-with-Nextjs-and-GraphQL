        ...
        <Container>
          <Stack width="100%" spacing={6}>
            <Stack width="100%" spacing={3} justifyContent="center" alignItems="center">
              ...
              <Span kind={tablet ? 'h0' : 'h8'} style={{ textAlign: 'center' }}>İstiklal Mahallesi Yeşildağ Sokak No:1 Esenyurt/İstanbul</Span>
              <Span kind={tablet ? 'h0' : 'h8'}><a href="+90532 746 03 82"> Whatsapp ve İletişim No:0532 746 03 82</a></Span>
            </Stack>
            <Stack width="100%" spacing={3} justifyContent="center" alignItems="center">
              <MapEmbed />
            </Stack>
