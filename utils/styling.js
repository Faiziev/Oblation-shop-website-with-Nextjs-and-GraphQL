...
export const GREY = 'rgba(0, 0, 0, 0.55)';
export const ORANGE = '#bc9553';
export const GOLD = 'rgb(255, 221, 113)';
export const BLOOD = 'rgb(136, 8, 8)';
export const BORDER = '#adadad';
export const BACKGROUND = '#fff';
export const HEADER = 'linear-gradient(0deg, rgba(255,255,255,1) 0%, rgba(255,255,255, 0.95) 100%)';
...
export const kinds = {
  b: { color: DARK, fontWeight: 600, fontStyle: 'bold' },
  g: { color: ORANGE, fontWeight: 600 },
  ...
  i: { color: DARK, fontWeight: 'normal', fontStyle: 'italic' },
  u: { color: DARK, fontWeight: 'normal', textDecoration: 'underline' },
...
export function GradientSpan({ gradient, children, gradientFont, normalFont }) {
  ...
  return (
    <Span
      ...
      style={
        hasGradient ? { background: `-webkit-linear-gradient(${gradient})`,
